# -*- coding: utf-8 -*-
"""
Created on Mon Sep  7 18:56:19 2020
...
button_style = {'background-color': 'black',
                      'color': 'yellow',
                      }
...
def create_app_ui():
  ...
  html.H1('Terrorism Analysis with Insights', id='Main_title',style={'background-image': 'url(terriorsm.jpg)'}  ),
  dcc.Tabs(id="Tabs", value="Map",children=[
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map",style=button_style , children=[
          dcc.Tabs(id = "subtabs", value = "WorldMap", style=button_style ,children = [
              dcc.Tab(label="World Map tool", id="World",style=button_style , value="WorldMap"),
              dcc.Tab(label="India Map tool", id="India", style=button_style ,value="IndiaMap")
              ]),
          dcc.Dropdown(
              id='month', 
                options=month_list,
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart",style=button_style , children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",style=button_style ,children = [
              dcc.Tab(label="World Chart tool", id="WorldC",style=button_style , value="WorldChart"),          
            dcc.Tab(label="India Chart tool", id="IndiaC",style=button_style , value="IndiaChart")]),
